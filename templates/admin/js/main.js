...
/*	Chosen select librairy call	*/
	...
	jQuery("select.ajax_chosen_select").ajaxChosen({
		method: 'POST',
		url: ajaxurl + "?action=wpshop_element_search&wpshop_ajax_nonce=" + jQuery("#wpshop_nonce_ajax_search").val() + "&wpshop_element_type=" + jQuery("#wpshop_ajax_search_element_type").val() + "&wpshop_format_result=0",
		dataType: 'json',
