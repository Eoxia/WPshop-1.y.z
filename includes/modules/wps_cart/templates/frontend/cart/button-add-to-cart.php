...
<button itemprop="availability" content="in_stock" id="wpshop_add_to_cart_<?php echo $args['pid']; ?>" class="wpshop_add_to_cart_button wps-bton-first-mini-rounded"><i class="wps-icon-basket"></i><?php echo $button_text; ?></button>