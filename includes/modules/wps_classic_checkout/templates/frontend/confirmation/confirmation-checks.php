...
<div class="wps-boxed">
	...
	<p><?php echo sprintf(__('You have to send the check with an amount of %s ATI to about "%s" to the adress :', 'wpshop'), $amount.' '.wpshop_tools::wpshop_get_currency( false ), ( ( !empty($company_infos['company_name']) ) ? $company_infos['company_name'] : '') ); ?></p>
