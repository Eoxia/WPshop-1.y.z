...
<div class="wps-quotation-addon-state-container" >
	...
	<input type="text" name="wps-quotation-check-code-value" id="wps-quotation-check-code-value" value="" placeholder="<?php _e( 'Type your code here', 'wpshop' ); ?>" /><button class="wps-bton-mini-third-rounded wps-bton-loading" id="wps-quotation-check-code-button" ><?php _e( 'Check code', 'wpshop' ); ?></button>
</div>