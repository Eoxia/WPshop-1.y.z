...
class wps_product_variation_interface
{
    ...
    private function meta_box_variation($post)
    {
        ...
        wp_enqueue_script('wps-product-variation-interface-script-utils', WPSPDTVARIATION_INTERFACE_ASSETS_MAIN_DIR . '/js/script-backend-utils.js');
				$product_definition = apply_filters( 'wps_filters_product_variation_extra_columns_product_definition', array(
        ...
        wp_localize_script('wps-product-variation-interface-script', 'wps_product_variation_interface', $product_definition );
